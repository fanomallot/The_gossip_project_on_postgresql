...
u = User.all 
40.times do
	Gossip.create(title: Faker::Team.name, content: Faker::Hipster.paragraph(sentence_count: 2, supplemental: false, random_sentences_to_add: 4), tags: [t[rand(0..9)],t[rand(0..9)]], user: u[rand(0..14)])
end
g = Gossip.all 
20.times do 
...
20.times do
	Comment.create(content: Faker::Hipster.paragraphs(number: 1), user: u[rand(0..14)] ,gossip: g[rand(0..59)])	
end
